...
import type { ListAbWidgetsParams, Widget } from '../model';
...
export class AbWidgetService {
  private readonly http = inject(HttpClient);
  listAbWidgets<TData = Widget[]>(
    params?: ListAbWidgetsParams,
  ...
  listAbWidgets<TData = Widget[]>(
    ...
    if (options?.observe === 'events') {
      return this.http.get<TData>(`/ab-widgets`, {
