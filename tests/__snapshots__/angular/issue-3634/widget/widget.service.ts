...
import type { ListWidgetsParams, Widget } from '../model';
...
export class WidgetService {
  ...
  listWidgets<TData = Widget[]>(
    ...
    if (options?.observe === 'events') {
      return this.http.get<TData>(`/widgets`, {
...
export type ListWidgetsClientResult = NonNullable<Widget[]>;
